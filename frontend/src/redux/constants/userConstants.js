...
export const USER_LOAD_ALL_REQUEST = "USER_LOAD_ALL_REQUEST";
export const USER_LOAD_ALL_SUCCESS = "USER_LOAD_ALL_SUCCESS";
export const USER_LOAD_ALL_FAIL = "USER_LOAD_ALL_FAIL";
export const USER_LOAD_ALL_RESET = "USER_LOAD_ALL_RESET";
